                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update',$product->id) }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea placeholder="Description" class="form-control form-control-lg"
                                    name="description" cols="30" rows="5">{{ old('description',$product->description) }}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                @if ($product->image != "")
                                    <img class="w-50 my-3 preview-img shadow-sm"
